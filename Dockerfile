...
RUN wget https://github.com/github/codeql-action/releases/download/codeql-bundle-v2.19.3/codeql-bundle-linux64.tar.gz\
...
# Some of the builds here fail because crates use conditional compilation,
